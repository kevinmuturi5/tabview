...
//list adapter to manage how data should be displayed on screen
public class ListAdapter extends ArrayAdapter {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
       View row=convertView;
        ...
        //incase no data from database ..it will display something
        if (row==null)
        {
        ...
        //else if there is data go on and fetch that data/dispaly
        else
        {
